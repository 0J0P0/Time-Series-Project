...
La independencia de los residuos se considera la hiótesis más importante o crítica a la hora de validar el modelo. Para este caso, se usarán como herramientas el ACF y PACF de los residuos y el test de Ljung-Box que permite prueba la hipótesis nula de que las autocorrelaciones de los residuos hasta un desfase *k* son conjuntamente iguales a cero; en otras palabras, independientes.
...
Para poder comprobar si los modelos son estables tenemos que recortar las últimas muestras de la serie (en este caso las 12 últimas) y comprobar si, al ajustar cada modelo con la serie recortada se mantienen unos coeficientes muy similares a los de los modelos previos.
...
Respecto al segundo modelo, a pesar que los signos no cambian, las magnitudes de los coeficientes varian de mucho más considerable que para el primer modelo.
```{r}
