...
*PONERLOS EN BONITO EN EL LATEX*
...
Teniendo en cuenta esto, y la comparación de los AIC, hay dos modelos que sobresalen en ambos casos. Estos son el modelo 2 ARMA(2,1)AR(4), y el modelo 3 AR(2)ARMA(2,2), con AIC's -190.12 y -189.7 y siendo los dos modelos con una mejor significación de parámetros.
