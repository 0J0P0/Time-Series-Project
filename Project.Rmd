...
```{r}
ts_seasonal(ser, type="all", title=" <b> Seasonality plot for Time Series <b>")
```
...
Nos damos cuenta tmabién de que el tercer mes del año tiene muetsras con valores que aumentan y seguidamente caen ligeramente en el abril. (EXPLICACION). Aunque estas muestras presentan una distribución con mucha variabilidad dependiendo del año, como se identifica en el tercer gráfico.
...
```{r}
ts_seasonal(d12ser, type="all", title=" <b> Seasonality plot for Time Series <b>")
```
