...
```{r}
# plot(bcserEC-bcserEC.lin)
f1 = plot_ly(x = time(bcserEC), y = (bcserEC-bcserEC.lin),
             type = "scatter",
             mode="lines",
             fill=F,
             line = list(color = "#2a788e"),
...
d1d1d12bcserEC.lin=diff(d1d12bcserEC.lin)
var(d1d1d12bcserEC.lin)[1]
```


```{r}
# plot(d1d12bcserEC.lin)
f1 = plot_ly(x = time(d1d12bcserEC.lin), y = (d1d12bcserEC.lin),
             type = "scatter",
             mode="lines",
             fill="tonexty",
             line = list(color = "#2a788e"),
