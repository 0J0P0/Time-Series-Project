...
Aun sabiendo que los retrasos del ACF no presentan un decreciemiento evidente, se podría considerar una media móvil de parámetro $q=6$. Aunque los retrasos intermedios no presentan significación clara, el sexto retraso esatcional si es significativo. En cambio esta propuesta incorpora al modelo una mayor complejidad en comparación con la parte autoregresiva propuesta con antelación, con lo que nos decantaremos por mantener solamente una parte AR(4) o bien proponer un ARMA que explique esta parte estacional.
