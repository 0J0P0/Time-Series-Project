...
Otro hehco a destacar sobre la serie son un par de observaciones con magnitudes que sobresalen notablemente en el mes de febrero (finales de enero e inicios de febrero) de 2011 y 2017. Los datos oficiales indican que en ambos casos los principales impulsores de esta subida fueron el sector del petróleo y el gas natural, junto al sector agrícola y pesquero. ESTO NO SE SI QUITARLO -> (Una posible hipótesis para la segunda observación supone que haya sido causa de un incremento de las exportaciones debido a los terremotos en Filipinas como muestra de apoyo y soliralidad hacía las personas implicadas. Aunque por el valor de la muestra, parece ser causa de un motivo distinto.)
