...
Vease que no hay un claro aumento de la variancia entre los valores inciales y finales de la serie. Se podría razonar que todo el conjunto de puntos mantiene la misma dispersión.
...
Para el caso de esta serie temporal observamos que si se cumple esta condición, por lo que consideramos no necesaria una transformación logaritmica para la serie.
...
Nos damos cuenta tmabién de que el tercer mes del año tiene muetsras con valores que aumentan y seguidamente caen ligeramente en el abril o viceversa. (EXPLICACION). Aunque estas muestras presentan una distribución con mucha variabilidad dependiendo del año, como se identifica en el tercer gráfico.

Se procede a realizar la diferenciación estacional de orden 12.
...
Como la variancia de la serie aumenta tras la diferenciación regular, se identifica que se ha realizado una sobrediferenciación, con lo que no es necesaria la aplicación de la trasnformación para asegurar media constante.
...
$$W_t = (1-B)(1-B^{12})\frac{X_t^\lambda-1}{\lambda}$$
